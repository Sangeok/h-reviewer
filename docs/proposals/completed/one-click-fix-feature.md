...
migrated-from: "docs/archive/one-click-fix-feature.md"
migration-note: "원문 SUPERSEDED 결정을 보존한다. 대체 명세 structured-inline-review-feature.md는 현재 문서 집합에 없다. 원래 닫힌 날짜와 승인자는 미상이다."
---

> 이관 메모 (2026-09-06): 원문 SUPERSEDED 결정을 보존한다. 대체 명세 structured-inline-review-feature.md는 현재 문서 집합에 없다. 원래 닫힌 날짜와 승인자는 미상이다. 경로·메타데이터 변경 전의 hash와 검토 영수증은 당시 기록이며 새 검증 결과가 아니다.

# One-Click Fix Feature Spec

> 역사 자료 정리 (2026-09-06): 기존 문서에 남아 있던 병합 충돌 3곳의 `HEAD` 안과 `730fd80bdd4df8eb1d3ebc46877de1750870c7a0` 안을 각각 원문안 A·B로 구분해 보존했다. 명령·예시·구현 내용 중 하나를 현재의 정답으로 선택한 것이 아니다. 이 문서는 기존 SUPERSEDED 결정을 유지하는 폐기된 명세다.

> **Status**: SUPERSEDED → `structured-inline-review-feature.md` (이관 시 원본 없음: `structured-inline-review-feature.md`)에 통합
> **Created**: 2026-03-24
> **Branch**: `oneclickEdit`
