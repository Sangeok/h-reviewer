...
**적용 범위**: `features/*/ui/`, `components/*/ui/`
...
### 메인 → Parts (상대 경로)
```typescript
// features/repository/ui/repository-list.tsx
import { RepositoryCardSkeleton } from "./parts/repository-card-skeleton";
```

### Parts → 모듈 내부 (상대 경로)
```typescript
// features/dashboard/ui/parts/contribution-graph.tsx
...
```typescript
// ❌ 잘못됨
import { RepositoryCardSkeleton } from "@/features/repository/ui/parts/repository-card-skeleton";
```
...
```typescript
// ❌ 잘못됨
features/dashboard/ui/parts/graph/parts/tooltip.tsx

// ✅ 올바름
features/dashboard/ui/parts/graph-tooltip.tsx
```
